...
function main() {
    let goods = [
        new Good(1, "Телефон", "Смартфон", [35, 36], 7000),
        new Good(2, "Мышь", "Оптическая мышь", [42, 46], 2000),
        new Good(3, "Монитор", "Монитор 6К", [21, 22], 3000),
        new Good(4, "Планшет", "Графический планшет",  [24, 25], 2500),
        new Good(5, "SSD", "SSD 1TB", [28, 29], 1000),
    ]
    ...
    let basketGoods = [
        new BasketGood(1, "Телефон", "Смартфон", [35, 36], 7000, 5),
        new BasketGood(2, "Мышь", "Оптическая мышь", [42, 46], 2000, 4),
        new BasketGood(3, "Монитор", "Монитор 6К", [21, 22], 3000, 7),
        new BasketGood(4, "Планшет", "Графический планшет",  [24, 25], 2500, 9),
        new BasketGood(5, "SSD", "SSD 1TB", [28, 29], 1000, 11),
    ]
